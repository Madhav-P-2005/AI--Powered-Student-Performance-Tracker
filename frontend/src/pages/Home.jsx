...
const Home = () => {
  ...
  return (
    <div className="relative overflow-hidden isolate -mt-6">
      ...
      {/* ═══════════ FOOTER ═══════════ */}
      <footer className="relative z-10 border-t border-slate-200/50 dark:border-slate-800 py-8">
        <div className="flex flex-col items-center gap-4">
          <div className="flex items-center gap-5">
            <a href="https://github.com/Madhav-P-2005/" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-slate-700 dark:hover:text-white transition-colors" aria-label="GitHub">
            ...
            <a href="https://www.instagram.com/madhavp_14/" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-pink-500 transition-colors" aria-label="Instagram">
